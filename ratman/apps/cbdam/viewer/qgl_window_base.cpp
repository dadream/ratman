...
qgl_window_base::qgl_window_base(QWidget* parent)
  : QGLWidget(parent) {
  //  :  QGLWidget(QGLFormat(QGL::DoubleBuffer|QGL::DepthBuffer|QGL::Rgba|QGL::AccumBuffer|QGL::DirectRendering),parent ,name) {
}  
